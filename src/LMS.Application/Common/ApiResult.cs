...
public class ApiResult
{
    ...
    protected ApiResult(bool success, ApiError? error, int statusCode)
    {
        Success = success;
        Error = error;
    ...
    public static ApiResult SuccessResult() =>
        new(true, null, (int)HttpStatusCode.OK);
    ...
    public static ApiResult FailureResult(Error error) =>
        new(false, ApiError.FromError(error), GetStatusCode(error.Type));
    ...
    public static ApiResult FailureResult(string code, string message, ErrorType type = ErrorType.Failure) =>
        new(false, new ApiError(code, message), GetStatusCode(type));
    ...
    public static ApiResult Fail(string code, string message, int statusCode) =>
        new(false, new ApiError(code, message), statusCode);
...
public class ApiResult<TData> : ApiResult
{
    ...
    private ApiResult(TData? data, bool success, ApiError? error, int statusCode)
    ...
    public static ApiResult<TData> SuccessResult(TData data) =>
        new(data, true, null, (int)HttpStatusCode.OK);
    ...
    public static ApiResult<TData> SuccessResult(TData data, HttpStatusCode statusCode) =>
        new(data, true, null, (int)statusCode);

    /// <summary>
    /// Creates a successful response with data
    /// </summary>
    public static ApiResult<TData> Ok(TData data, int statusCode = HttpStatusCodes.Ok) =>
        new(data, true, null, statusCode);

    /// <summary>
    /// Creates a failure response from an error
    /// </summary>
    public new static ApiResult<TData> FailureResult(Error error) =>
        new(default, false, ApiError.FromError(error), GetStatusCode(error.Type));

    /// <summary>
    /// Creates a failure response from error details
    /// </summary>
    public new static ApiResult<TData> FailureResult(string code, string message, ErrorType type = ErrorType.Failure) =>
        new(default, false, new ApiError(code, message), GetStatusCode(type));

    /// <summary>
    /// Creates a failure response with explicit status code
    /// </summary>
    public static ApiResult<TData> Fail(string code, string message, int statusCode) =>
        new(default, false, new ApiError(code, message), statusCode);
}
...
public class ApiError
{
    ...
    /// <summary>
    /// Creates an ApiError from a domain Error
    /// </summary>
